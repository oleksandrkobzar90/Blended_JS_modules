...
// const newNumber = arr => arr.map(n => n ** 2);
...
// const flattenedValues = data.flatMap(d => d.values);
...
// const ageUnderTwenty = peoples.some(people => people.age < 20);
...
// const pairedElement = numbers.every(number => number % 2 === 0);
// console.log(pairedElement);
...
// const firstNonpairedElement = numbers.find(number => number % 2 !== 0);
// console.log(firstNonpairedElement);
...
// const sortElement = numbersArray.toSorted((a, b) => a - b);
...
// const sortAlphabet = stringArray.toSorted();
// console.log(sortAlphabet);

// const sortAlphabet1 = stringArray.toSorted((a, b) => a.localeCompare(b));
// console.log(sortAlphabet1);
...
// const filterUsers = user.filter(u => u.age > 20);
...
// const sumOfElem = numbers.reduce((previousValue, number) => previousValue + number, 0);
