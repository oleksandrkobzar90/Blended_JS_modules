...
const elemDataTopicAll = document.querySelectorAll('[data-topic]');
console.log(elemDataTopicAll);
...
//Або
// const elemDataTopicFirst = document.querySelectorAll('[data-topic]');
// console.log(elemDataTopicFirst[0]);

// 6 - отримай останній елемент з списку всіх елементів з атрибутом data-topic і виведи його в консоль;
const elemDataTopicAll2 = document.querySelectorAll('[data-topic]');
const elemDataTopicLast = elemDataTopicAll2[elemDataTopicAll2.length - 1];
...
h3.forEach(h3 => console.log(h3.textContent));

// 9 - для кожного елмента h3 додай class="active", який змінить колір заголовка на червоний колір
h3.forEach(h3 => h3.classList.add('active'));

// 10 - знайти елемент li який має атрибут data-topic з значенням "navigation" і виведи його в консоль;
const liNavigate = document.querySelector('li[data-topic="navigation"]');
console.log(liNavigate);

// 11 - додай для знайденого елемента data-topic="navigation" атрибут style і зроби його backgroundColor жовтим
liNavigate.style.backgroundColor = 'yellow';

// 12 - у елемента data-topic="navigation" знайди елемент р і зміни його текст на "Я змінив тут текст!".
const pNavigate = liNavigate.querySelector('p');
pNavigate.textContent = 'Я змінив тут текст!';
